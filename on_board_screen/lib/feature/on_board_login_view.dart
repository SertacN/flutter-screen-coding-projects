...
class OnBoardLoginView extends StatelessWidget {
  const OnBoardLoginView({super.key});

  @override
  Widget build(BuildContext context) {
    return ColumnAlignmentStart(children: [
      const OnBoardTitleText(title: OnBoardKeys.loginTitle),
      const OnBoardDescription(description: OnBoardKeys.loginDescription),
      OnBoardImage(imagePath: OnBoardImageConstant.login),
      const OnBoardContent(content: OnBoardKeys.loginContent),
    ]);
  }
}
